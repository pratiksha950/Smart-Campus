      ...
      <div className="text-xl bg-[#F8FAFF] font-sans">
        ...
        <div className="md:flex my-15 ">
          <div className="bg-white p-6 rounded-xl shadow mx-10 mb-5">
            ...
            <p className="text-gray-700">
              M1: Providing a conducive environment for effective
              teaching-learning, research, and innovation. M1: Providing a
              conducive environment for effective teaching-learning, research,
              and innovation. M2: Establishing an ecosystem to nurture
              state-of-the art skill sets through training, collaborating, and
              mentoring. 
            </p>
          </div>
          ...
          <div className="bg-white p-6 rounded-xl shadow mx-10">
            ...
            <p className="text-gray-700">
              To provide quality technical education to foster youth with skills
              and values to make them capable of delivering significant
              contributions in local to global development.
            </p>
          </div>
        </div>
        ...
        <div className="bg-white p-6 rounded-xl shadow md:mx-40 mx-3">
          <div className="md:flex md:justify-center md:items-center mb-7">
            <div>
              <input
                type="text"
                placeholder="Name"
                className="border md:w-80 w-60 px-3 rounded-xl mx-10"
              ...
              {addReview.error && (
                <p className="text-red-500 text-sm ml-12">{addReview.error}</p>
              )}
            </div>
          ...
          <div className="flex justify-center mb-5">
            <textarea
              placeholder="Message"
              className="border w-140 px-3 rounded-xl mx-10"
